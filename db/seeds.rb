...
#Create Careers
careersList = ['Agronomia', 'Arquitectura', 'Arte', 'Computación', 'Economía', 
    'Educación física', 'Filosofía', 'Física', 'Geología', 'Historia', 'Literaruta', 
    'Matemáticas', 'Medicina', 'Periodismo', 'Química', 'Sociología', 'Veterinaria']
careersList.map { |c| Career.create(name: c)}
